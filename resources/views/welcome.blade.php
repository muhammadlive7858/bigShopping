...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta charset="utf-8">
          ...
          <title>Shop-control - Index</title>
...
<body data-aos-easing="ease-in-out" data-aos-duration="1000" data-aos-delay="0">
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+998945967858</span></i>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="{{ route('home') }}">Shop-control tizimlashgan savdo<span>.</span></a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo"><img src="assets/img/logo.png" alt=""></a>-->

      <nav id="navbar" class="navbar">
      <!--  <ul>-->
          <li><span class="nav-link scrollto active" href="#hero">
              @if (Route::has('login'))
                    @auth
                        <a  href="{{ route('admin.index') }}" class="btn btn-primary text-white fs-2 p-1 m-2">Home</a>
                    @else
                        
                        <a href="{{ route('login') }}"  class="btn btn-primary text-white fs-2 p-1 m-2">Log in</a>
                    @endauth
            @endif
          </span></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
      <h1>Do'konimizga <span>Xush kelipsiz</span></h1>
      <h2>Bizning do'konimizda xo'jalikdagi barcha turdagi mollorni topishingiz mumkin.</h2>
      <div class="d-flex">
        <a href="#about" class="btn-get-started scrollto">Rahmat</a>
        <a href="#" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span></span></a>
      </div>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box aos-init" data-aos="fade-up" data-aos-delay="100">
              ...
              <h4 class="title"><a href="">Sifatli maxsulot</a></h4>
              <p class="description">Xo'jalik mo'llari</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box aos-init" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 class="title"><a href="">Ishonchli xizmat</a></h4>
              <p class="description">Barcha turdagi xizmat va maxsulotlar uchun.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box aos-init" data-aos="fade-up" data-aos-delay="300">
              ...
              <h4 class="title"><a href="">Tez va oson</a></h4>
              <p class="description">Maxsus tizimlashtirilgan.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box aos-init" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 class="title"><a href="">Barakali xizmat</a></h4>
              <p class="description">Siz uchun .......</p>
            </div>
          </div>
    ...
    <section id="about" class="about section-bg">
     ...
     <div class="row">
          <div class="col-lg-6 aos-init" data-aos="fade-right" data-aos-delay="100">
            <img src="assets/img/about.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center aos-init" data-aos="fade-up" data-aos-delay="100">
     ...
     <div class="row">
       ...
       <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="1463" data-purecounter-duration="1" class="purecounter">0</span>
       ...
       <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="15" data-purecounter-duration="1" class="purecounter">0</span>
              <p>Hard Workers</p>
            </div>
          </div>
     </div>
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('front/BizLand/assets/vendor/purecounter/purecounter_vanilla.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/swiper/swiper-bundle.min.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/waypoints/noframework.waypoints.js') }}"></script>
  <script src="{{ asset('front/BizLand/assets/vendor/php-email-form/validate.js') }}"></script>

  <!-- Template Main JS File -->
  <script src="{{ asset('front/BizLand/assets/js/main.js') }}"></script>
